...
public class ActionBarDrawerToggle extends android.support.v4.app.ActionBarDrawerToggle {
    ...
    public ActionBarDrawerToggle(AppCompatActivity activity, DrawerLayout drawerLayout, int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
    ...
    public ActionBarDrawerToggle(AppCompatActivity activity, DrawerLayout drawerLayout, DrawerArrowDrawable drawerImage, int openDrawerContentDescRes, int closeDrawerContentDescRes) {
        super(activity, drawerLayout, R.mipmap.ic_launcher, openDrawerContentDescRes, closeDrawerContentDescRes);
        mActivity = activity;
